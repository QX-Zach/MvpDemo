...
/**
 * Created by ozner_67 on 2016/5/9.
 */
public class PahtEffectView extends View {
    ...
    public PahtEffectView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PahtEffectView(Context context, AttributeSet attrs, int defStyleAttr) {
